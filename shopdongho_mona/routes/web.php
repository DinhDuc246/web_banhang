...
Route::post('/save-xl','OrderController@save_xl');
...
//order
Route::get('/order/{order_code}','HomeController@order');
Route::get('/delete-order/{order_code}','HomeController@delete_order');

Route::post('/email/{order_code}','HomeController@email');
